...
<div class="container-fluid">
    ...
    <div class="row">
                ...
                <div class="row">
                    <div class="isotope">
                        ...
                        <div class="col-xs-4 col-md-4 element-item lanthanoid  " data-category="diatomic">                            
                                <img class="img-responsive" alt="Conductor" src="<?php echo base_url();?>noti_img/conductores/cugalde_color.jpg"><br>                            
                        </div>
        ...
        <div class="col-xs-12 col-md-8">
            <img class="img-responsive rollover" alt="Semblanza" src="<?php echo base_url();?>noti_img/portadas_conductores/cugalde.jpg"><br>
            <div class="container-fluid">
                <div class="col-xs-1 col-md-1"></div>
                <div class="col-xs-10 col-md-10">
                    <p class="text-right"><h2 class="text-right"><p class="letra-color"><strong>LUIS CARLOS UGALDE</strong></p></h2></p>
                    <p class="text-justify">Fundador y Director General de Integralia Consultores, especializada en inteligencia legislativa y política, planeación estratégica y políticas de transparencia y rendición de cuentas.</p>
                    <p class="text-justify">Con amplia experiencia de gobierno y en instituciones públicas, entre ellas la Embajada de México en los Estados Unidos de América, la oficina de la Presidencia de la República y la Secretaría de Energía. </p>
                    <p class="text-justify">Fue Consejero Presidente del Instituto Federal Electoral (IFE) hoy INE, entre 2003 y 2007. Ha sido profesor de ciencia política e investigador en varias Universidades de México y los Estados Unidos, entre ellas el Instituto Tecnológico Autónomo de México (ITAM), el Centro de Investigación y Docencia Económicas (CIDE), la Universidad de Harvard, así como las Universidades de Georgetown y Americana, en Washington, D.C.</p>
                    <p class="text-justify">Ha publicado libros sobre democracia y finanzas públicas, así como cientos de artículos académicos y de opinión en revistas especializadas y diarios en México y el extranjero. </p>
                    <p class="text-justify">Es fundador de Métrica Pública, Asociación Civil dedicada a promover la calidad de la democracia en México.</p>
                    <p class="text-justify">Conductor de Periférico 13 13, programa de análisis político de TV Azteca, editorialista del periódico El Financiero, así como comentarista en diversos noticiarios de la radio. </p>
                    <p class="text-justify">Luis Carlos Ugalde es Licenciado en Economía por el ITAM, Maestro en Administración Pública y Doctor en Ciencia Política por la Universidad de Columbia, en Nueva York.</p>
                </div>
                <div class="col-xs-1 col-md-1"></div>
            </div>
        </div>
