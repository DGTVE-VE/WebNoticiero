...
<div class="container-fluid">
    ...
    <div class="row">
                ...
                <div class="row">
                    <div class="isotope">
                        ...
                        <div class="col-xs-4 col-md-4 element-item transition  " data-category="alkaline-earth">                            
                                <img class="img-responsive" alt="Conductor" src="<?php echo base_url();?>noti_img/conductores/ggiron_color.jpg"><br>                            
                        </div>
        ...
        <div class="col-xs-12 col-md-8">
            <img class="img-responsive rollover" alt="Semblanza" src="<?php echo base_url();?>noti_img/portadas_conductores/ggyron.jpg"><br>
            <div class="container-fluid">
                <div class="col-xs-1 col-md-1"></div>
                <div class="col-xs-10 col-md-10">
                    <p class="text-right"><h2 class="text-right"><p class="letra-color"><strong>GUADALUPE GARCÍA GIRÓN</strong></p></h2></p>
                    <p class="text-justify">Conductora en la sección internacional del noticiario “México al Día” DGTVE, desde enero 2014.</p>
                    <p class="text-justify">Titulada como Lic. en Ciencias de la Comunicación de la Universidad de Sonora. Campus Hermosillo 2006 Participó como Staff organizador del 2do Congreso Internacional de Ciencias de la Comunicación de la Universidad de Sonora.</p>
                    <p class="text-justify">2007 Fue Maestra de Ceremonias de la X JORNADAS MÉDICAS del Hospital General “Dr. Fernando Ocaranza” ISSSTE.</p>
                    <p class="text-justify">2007 Participó en la creación de campaña dentro del encuentro de valore2 del Gobierno de Sonora (concurso de creatividad de Studio Valores). Valores Sonora.</p>
                    <p class="text-justify">2008 Asistente de Producción en Dreams Factory Productions.</p>
                    <p class="text-justify">2009 Asistente de Producción en ESPN, Sportscenter.</p>
                    <p class="text-justify">2009 Curso de Locución y conducción de programas educativos, en el Centro de Entrenamiento de Televisión Educativa</p>
                    <p class="text-justify">2009-2010 Asistente de Producción en la Dirección General de Televisión Educativa, noticiero México al Día.</p>
                    <p class="text-justify">Actualmente es reportera, redactora y conductora de la Sección de Notas Internacionales del Noticiero “México al Día MD”.</p>
                </div>
                <div class="col-xs-1 col-md-1"></div>
            </div>
        </div>
