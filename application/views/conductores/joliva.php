...
<div class="container-fluid">
    ...
    <div class="row">
                ...
                <div class="row">
                    <div class="isotope">
                        ...
                        <div class="col-xs-4 col-md-4 element-item transition  " data-category="alkaline-earth">                            
                            <a href="ggiron.php">
                                <img class="img-responsive" alt="Conductor" src="<?php echo base_url();?>noti_img/conductores/ggiron_bn.jpg"><br>                            
                            </a>
                        </div>
                        ...
                        <div class="col-xs-4 col-md-4 element-item lanthanoid " data-category="metalloid">                            
                                <img class="img-responsive" alt="Conductor" src="<?php echo base_url();?>noti_img/conductores/joliva_color.jpg"><br>                            
                        </div>
        ...
        <div class="col-xs-12 col-md-8">
            <img class="img-responsive rollover" alt="Semblanza" src="<?php echo base_url();?>noti_img/portadas_conductores/joliva.jpg"><br>
            <div class="container-fluid">
                <div class="col-xs-1 col-md-1"></div>
                <div class="col-xs-10 col-md-10">
                    <p class="text-right"><h2 class="text-right"><p class="letra-color"><strong>JAVIER OLIVA</strong></p></h2></p>
                    <p class="text-justify">Profesor Titular de Tiempo Completo en la Facultad de Ciencias Políticas y Sociales de la UNAM.</p>
                    <p class="text-justify">Doctor en Ciencia Política por la UNAM.</p>
                    <p class="text-justify">Residencia de investigación postdoctorado en el Instituto de Estudios Políticos en París.</p>
                    <p class="text-justify">Coordinador del Diplomado en Defensa y Seguridad Nacionales en la UNAM.</p>
                    <p class="text-justify">Autor de ensayos y libros especializados en temas de Defensa y Seguridad Nacionales.</p>
                    <p class="text-justify">Estudios de doctorado en Sociología  del Derecho, en la Universidad  de Lecce, Italia.</p>
                </div>
                <div class="col-xs-1 col-md-1"></div>
            </div>
        </div>
