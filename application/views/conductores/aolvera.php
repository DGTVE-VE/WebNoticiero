...
<div class="container-fluid">
    ...
    <div class="row">
                ...
                <div class="row">
                    <div class="isotope">
                        ...
                        <div class="col-xs-4 col-md-4 element-item metal  " data-category="post-transition">
                            <img class="img-responsive" alt="Conductor" src="<?php echo base_url();?>noti_img/conductores/aolvera_color.jpg"><br>
                        </div>
        ...
        <div class="col-xs-12 col-md-8">
            <img class="img-responsive rollover" alt="Semblanza" src="<?php echo base_url();?>noti_img/portadas_conductores/aolvera.jpg"><br>
            <div class="container-fluid">
                <div class="col-xs-1 col-md-1"></div>
                <div class="col-xs-10 col-md-10">
                    <p class="text-right"><h2 class="text-right"><p class="letra-color"><strong>ANA CRISTINA OLVERA</strong></p></h2></p>
                    <p class="text-justify">Licenciada en Filosofía por la Universidad Iberoamericana. Inició en la conducción en 1997 con el Sistema ECO de noticias.</p>
                    <p class="text-justify">Ha sido conductora del espacio informativo “Noticias en 30” y del programa “En Tiempo Real” de Efekto Noticias, espacios en los que se especializó en el manejo de información que circula a través de las redes sociales e Internet, así como temas científicos, tecnológicos y culturales. De igual forma participó en varios proyectos en Radio Capital.</p>
                    <p class="text-justify">Actualmente conduce la sección de redes sociales e internet del noticiario matutino “México al Día” de Televisión Educativa.</p>
                </div>
                <div class="col-xs-1 col-md-1"></div>
            </div>
        </div>
