            ...
            <a href="<?php echo base_url();?>">
                        ...
                        <div id="filtering-demo" class="demo text-center">
                            ...
                            <div class="col-xs-4 col-md-4 element-item metal diatomic" data-category="metalloid">
                                    <img class="img-responsive " alt="Conductor" src="<?php echo base_url();?>noti_img/conductores/ocepeda_color.jpg"><br>
                            </div>
                    ...
                    <div class="col-xs-12 col-md-8">
                        <img class="img-responsive rollover" alt="Semblanza" src="<?php echo base_url();?>noti_img/portadas_conductores/ocepeda.jpg"><br>
                        <div class="container-fluid">
                            <div class="col-xs-1 col-md-1"></div>
                            <div class="col-xs-10 col-md-10">
                                <p class="text-right"><h2 class="text-right"><p class="letra-color"><strong>OMAR CEPEDA</strong></p></h2></p>
                                <p class="text-justify">Productor, reportero, conductor y traductor especializado en temas internacionales. Estudió la licenciatura en Relaciones Internacionales en el Tecnológico de Monterrey, en 2007 realizó un Master en Estudios Internacionales por la Universidad del País Vasco.</p>
                                <p class="text-justify">Columnista en la revista “Voz y Voto”, especializada en temas políticos y electorales. Diseñó escenarios para la toma de decisiones políticas y estrategias discursivas a funcionarios públicos.</p>
                                <p class="text-justify">En Concepto Radial del Tecnológico de Monterrey participó en la producción y locución de programas políticos como “Café México” y el musical-cultural “Ventana al Tiempo” 94.9 FM. En las editoriales “Educar” diseñó los libros de texto para el Instituto Nacional para la Educación de los Adultos INEA y en el Diario “El Sol de México” colaboró como reportero y enviado especial.</p>
                            </div>
                            <div class="col-xs-1 col-md-1"></div>
                        </div>
                    </div>
