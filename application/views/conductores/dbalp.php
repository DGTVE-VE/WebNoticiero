...
<div class="container-fluid">
    ...
    <div class="row">
            ...
            <div id="filtering-demo" class="demo text-center">
                ...
                <div class="row">
                    <div class="isotope">
                        ...
                        <div class="col-xs-4 col-md-4 element-item  metal  " data-category="transition">
                            <img class="img-responsive" alt="Conductor" src="<?php echo base_url();?>noti_img/conductores/dbalp_color.jpg"><br>
                        </div>
        ...
        <div class="col-xs-12 col-md-8">
            <img class="img-responsive rollover" alt="Semblanza" src="<?php echo base_url();?>noti_img/portadas_conductores/dbalp.jpg"><br>
            <div class="container-fluid">
                <div class="col-xs-1 col-md-1"></div>
                <div class="col-xs-10 col-md-10">
                    <p class="text-right"><h2 class="text-right"><p class="letra-color"><strong>DALIA BALP</strong></p></h2></p>
                    <p class="text-justify">Licenciada en Psicología por la Universidad Nacional Autónoma de México. Cursó el Diplomado de Conducción y Locución para Televisión, Radio y otros medios en el Centro de Capacitación Televisiva de la Dirección General de Televisión Educativa.</p>
                    <p class="text-justify">Egresada de la Escuela Nacional de Danza Clásica y Contemporánea del INBA  y con un marcado interés por las artes escénicas, se ha desempeñado como actriz y bailarina en escenarios como el Palacio de Bellas Artes, el Auditorio Nacional, el Teatro de la Ciudad “Esperanza Iris”, entre muchos otros escenarios de la República Mexicana y del extranjero. </p>
                    <p class="text-justify">Durante una estancia en Canadá, realizó estudios en la Universidad de McGill, fue miembro fundadora de la Asociación de Danza-Movimiento Terapia en Canadá, trabajó en el Consulado General de México en Montreal, así como en participaciones en teatro, danza y cine dentro dela provincia de Quebec.</p>
                    <p class="text-justify">Su cercanía y amor a la música la ha llevado a ser locutora de “Música en México”, asociación cuya misión es la difusión de la música clásica y contemporánea.</p>
                    <p class="text-justify">Dentro Televisión Educativa ha sido conductora de series como “Leo, camino y sueño”, “Entre libros”, “Telesecundaria-Danza II”, así como la serie “Los Niños y la Danza”, en la cual también realizó el contenido pedagógico. Actualmente conduce la sección Arte y Cultura del noticiario matutino de “México al Día”.</p>
                </div>
                <div class="col-xs-1 col-md-1"></div>
            </div>
        </div>
