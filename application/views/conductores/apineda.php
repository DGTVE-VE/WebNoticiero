...
<div class="container-fluid">
    ...
    <div class="row">
                ...
                <div class="row">
                    <div class="isotope">
                        ...
                        <div class="col-xs-4 col-md-4 element-item alkali  " data-category="transition">                            
                                <img class="img-responsive" alt="Conductor" src="<?php echo base_url();?>noti_img/conductores/apineda_color.jpg"><br>                            
                        </div>
        ...
        <div class="col-xs-12 col-md-8">
            <img class="img-responsive rollover" alt="Semblanza" src="<?php echo base_url();?>noti_img/portadas_conductores/apineda.jpg"><br>
            <div class="container-fluid">
                <div class="col-xs-1 col-md-1"></div>
                <div class="col-xs-10 col-md-10">
                    <p class="text-right"><h2 class="text-right"><p class="letra-color"><strong>ALEJANDRO PINEDA</strong></p></h2></p>
                    <p class="text-justify">Conductor y comentarista especializado en temas internacionales. Estudió en la Facultad de Ciencias Políticas y Sociales de la UNAM la Licenciatura en Relaciones Internacionales. Realizó un diplomado en “Análisis Político y Estratégico” en el Centro de Investigación y Docencia Económicas CIDE.</p>
                    <p class="text-justify">Subdirector en la Dirección del protocolo de la Secretaría de Relaciones Exteriores (2000); Director de  Enlace Interinstitucional de la Dirección General de Televisión Educativa (2008) y Director de Comunicación con Medios internacionales y Gobierno Federal de la Coordinación de Comunicación Social de la Presidencia de la República (2012). Actualmente participa en la Conducción del noticiario nocturno de “México al Día” de Televisión Educativa.</p>                    
                </div>
                <div class="col-xs-1 col-md-1"></div>
            </div>
        </div>
