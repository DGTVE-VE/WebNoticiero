            ...
            <a href="<?php echo base_url();?>">
                        ...
                        <div id="filtering-demo" class="demo text-center">
                            ...
                            <div class="col-xs-4 col-md-4 element-item alkali diatomic " data-category="lanthanoid">
                                    <img class="img-responsive" alt="Conductor" src="<?php echo base_url();?>noti_img/conductores/lcarbajal_color.jpg"><br>
                            </div>
                    ...
                    <div class="col-xs-12 col-md-8">
                        <img class="img-responsive rollover" alt="Semblanza" src="<?php echo base_url();?>noti_img/portadas_conductores/lcarbajal.jpg"><br>
                        <div class="container-fluid">
                            <div class="col-xs-1 col-md-1"></div>
                            <div class="col-xs-10 col-md-10">
                                <p class="text-right"><h2 class="text-right"><p class="letra-color"><strong>LETICIA CARBAJAL ARELLANO</strong></p></h2></p>
                                <p class="text-justify">Productora, Conductora y Reportera de radio y televisión. Estudió la Licenciatura en Ciencias de la Comunicación en la Universidad Tecnológica de México.</p>
                                <p class="text-justify">En TV Azteca fue reportera del programa “Frente a Frente” con Lolita de la Vega.</p>
                                <p class="text-justify">Colaboró como asistente de producción del programa “Janette Arceo y la Mujer Actual” para posteriormente ser Productora de la barra de noticieros de fin de semana en Grupo Fórmula durante 3 años. </p>
                                <p class="text-justify">En Televisión Educativa fue reportera y co‐conductora del programa semanal “En Resumen”.</p>
                                <p class="text-justify">En “Greentv la Televisión Viva” trabajó como Coordinadora de Producción del canal y conductora del programa “El Noticiero de la Salud” junto con el Dr. Erick Estrada. En Radio Capital fue productora y conductora del programa “Noticias todo el tiempo” de 16:00 a 18:00 hrs de lunes a viernes durante 2 años.</p>
                                <p class="text-justify">Actualmente en la Dirección General de Televisión Educativa es Jefa de Información de los
Noticieros “México al Día”. Bajo su cargo también se encuentra la conducción de las noticias nacionales en el noticiero nocturno “México al Día” y del programa “En Corto”.
</p>
