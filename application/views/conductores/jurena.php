...
<div class="container-fluid">
    ...
    <div class="row">
                ...
                <div class="row">
                    <div class="isotope">
                        ...
                        <div class="col-xs-4 col-md-4 element-item lanthanoid  diatomic" data-category="actinoid">                            
                                <img class="img-responsive" alt="Reportajes" src="<?php echo base_url();?>noti_img/conductores/jurena_color.jpg"><br>                            
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xs-12 col-md-8">
            <img class="img-responsive rollover" alt="Semblanza" src="<?php echo base_url();?>noti_img/portadas_conductores/jurena.jpg"><br>
            <div class="container-fluid">
                <div class="col-xs-1 col-md-1"></div>
                <div class="col-xs-10 col-md-10">
                    <p class="text-right"><h2 class="text-right"><p class="letra-color"><strong>JOSÉ UREÑA</strong></p></h2></p>
                    <p class="text-justify">Periodista, autodidacta con más de 40 años de experiencia. Formado en Guadalajara y dedicado a entrevistas y análisis políticos. Autor de la columna Teléfono Rojo que se publica en varios periódicos del país y Director de la página web con el mismo nombre.</p>
                    <p class="text-justify">Ha colaborado en diversos medios impresos, dentro de los que destacan:</p>
                        <li>El informador de Guadalajara 1960 a 1971</li>
                        <li>El diario de Guadalajara hasta 1977</li>
                        <li>Uno más uno de 1977 a 1980</li>
                        <li>El universal de 1980 a 1984</li>
                        <li>La Jornada, de 1974 a 1997</li>
                        <li>Ovaciones 1997 a 2013</li>
                        <li>Diario 24 hrs</li>
                        <p></p>
                    <p class="text-justify">Actualmente es conductor de los Programas “Mesa Cuadrada” y “En Corto” de la Dirección General de Televisión Educativa.</p>
                </div>
                <div class="col-xs-1 col-md-1"></div>
            </div>
        </div>
