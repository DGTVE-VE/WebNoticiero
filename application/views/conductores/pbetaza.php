    ...
    <div class="row">
        <div class="col-xs-12 col-md-4 well">
                    ...
                    <div class="row">
                        <div class="isotope">
                            <div class="col-xs-4 col-md-4 element-item  metal " data-category="transition">
                                <img class="img-responsive" alt="Conductor" src="<?php echo base_url();?>noti_img/conductores/pbetaza_color.jpg"><br>
                            </div>
            ...
            <div class="col-xs-12 col-md-8">
                <img class="img-responsive rollover" alt="Semblanza" src="<?php echo base_url();?>noti_img/portadas_conductores/pbetaza.jpg"><br>
                <div class="container-fluid">
                    <div class="col-xs-1 col-md-1"></div>
                    <div class="col-xs-10 col-md-10">
                        <p class="text-right"><h2 class="text-right"><p class="letra-color"><strong>PATRICIA BETAZA</strong></p></h2></p>
                        <p class="text-justify">Reportera, conductora, redactora y productora de noticieros en Televisión, egresada de la Escuela de Periodismo “Carlos Septién García”. Cuenta con una preparación profesional en Televisa de producción y periodismo documental con Pete Fuentes, reconocido periodista de televisión de la cadena Fox de Estados Unidos.</p>
                        <p class="text-justify">En Televisión Mexiquense realizó la imagen pública con Ana Vásquez Colmenares y Klouster Asociados. Del 2005 al 2012 fue conductora titular del noticiario nocturno de Televisión Mexiquense cubriendo también emisiones especiales de personajes y organismos del ámbito internacional.</p>
                        <p class="text-justify">Su trabajo informativo la ha hecho acreedora al Premio Nacional de Periodismo en Salud por el Secretario de Salud Julio Frenk. Actualmente es la conductora del noticiero “México al Día AM” de Televisión Educativa.</p>
                    </div>
                    <div class="col-xs-1 col-md-1"></div>
                </div>
            </div>
